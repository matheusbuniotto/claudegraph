...
Full config schema, commands, and the agent envelope contract. For an overview, see the
[README](../README.md).
...
max_parallel: 3             # optional, >= 1; validated but not yet used (execution is serial)
